    ...
    for line in output:
        if "hls" in line.lower():
            ...
            if lookupLink:
                ...
                if myLoc.startswith('svtplay') or myLoc.startswith('svtklipp') or myLoc.startswith('svtarchive') or myLoc.startswith("tv4play") or myLoc.startswith('nordond') or myLoc.startswith('mtgxse'):
